\documentclass[11pt, a4paper, BCOR12mm, headexclude, footexclude, twoside,%
openright]{scrartcl}
...
% Number equations within sections (i.e. 1.1, 1.2, 2.1, 2.2 instead of 1, 2, 3,
% 4)
...
\author{\bfseries{Romain Cotte}\vspace{-2ex}}
\date{\begin{tabular}{cc}
  \textsc{Date:}& \textsc{\emph{\today}}\\
  \textsc{Due :}& \textsc{\emph{3th January 2016}}\vspace{3ex}
\end{tabular}}
\maketitle
